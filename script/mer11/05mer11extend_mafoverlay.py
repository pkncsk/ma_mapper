...
plt.show()
# %%
fused_maf_normalised=mapper.normalise(fused_maf_mapped_sorted)
# %%
...
#%%
fused_maf_mer11a_normalised=mapper.normalise(fused_maf_mer11a)
fused_maf_mer11b_normalised=mapper.normalise(fused_maf_mer11b)
fused_maf_mer11c_normalised=mapper.normalise(fused_maf_mer11c)
#%%
fig, axs = plt.subplots(3,1,figsize=(10,6), sharex=True, sharey=True)
axs[0].fill_between(range(len(fused_maf_normalised)), fused_maf_mer11a_normalised, color='grey')
axs[0].set_title('MER11A')
axs[1].fill_between(range(len(fused_maf_normalised)), fused_maf_mer11b_normalised, color='grey')
axs[1].set_title('MER11B')
axs[2].fill_between(range(len(fused_maf_normalised)), fused_maf_mer11c_normalised, color='grey')
