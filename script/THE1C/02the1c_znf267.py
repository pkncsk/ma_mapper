...
plot.overlay_plot([alignment_filtered,bam_forward, bam_reverse], metadata= metadata_age, nucleotide_color='white',data_vmax = [0.1,0.1],data_cmap=['Blues','Reds'], plot_title='ChIPexo_znf276', show_data_legend=True,data_label=['ChIP_forward','ChIP_reverse'])#%%
plot.overlay_plot([alignment_filtered,phylop,bam_forward, bam_reverse], metadata= metadata_age, nucleotide_color='white',data_vmin=[-0.5,0,0],data_vmax = [0.5,0.1,0.1],data_cmap=['RdBu','Purples','Oranges'], plot_title='ChIPexo_znf276', show_data_legend=True,data_label=['phyloP','ChIP_forward','ChIP_reverse'])
# %%
