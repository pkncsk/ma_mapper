...
#%%
graphical_object_sorted=sns.clustermap(pd.DataFrame(fused_vcf_mapped),row_colors=row_color_age_sorted, 
...
graphical_object_sorted.ax_heatmap.set_title("THE1C vcf overlay")
...
plt.show()
# %%
fused_vcf_normalised=mapper.normalise(fused_vcf_mapped)
# %%
plt.rcParams['figure.dpi'] = 600
plt.rcParams['savefig.dpi'] = 600
fig, ax = plt.subplots(figsize=(10,3))
ax.fill_between(range(len(fused_vcf_normalised)), fused_vcf_normalised, color='grey')
ax.margins(x=0, y=0)
ax.set_ylim(0,0.01)
ax.set_xlabel('position (bp)')
ax.set_ylabel('normalised alt allele freq ratio')
ax.set_title('THE1C VCF overlay')
plt.show()
#%%
