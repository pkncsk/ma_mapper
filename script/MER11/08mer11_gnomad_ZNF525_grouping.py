...
plots.plot_experimental(
    data = [vcf_sorted,znf525_sorted,znf808_sorted], alignment=alignment_filtered, 
    heatmap_color=['Blues','Oranges','Greens'],
    heatmap_title=['MER11A AAF sorted by ZNF525 binding','ChIP-exo ZNF525','ChIP-exo ZNF808'],  
    ...
    agg_major_tick=100,
    agg_titles=['mean AAF','ZNF525 p>a', 'ZNF525 p<a'],
    colorbar=True, 
...
from ma_mapper import mapper
plots.plot_experimental(
    data = [vcf_sorted,znf525_sorted], 
    alignment=alignment_filtered_subset, 
    heatmap_mode='spread_horizontal',
    heatmap_color=['Blues','Oranges'],
    heatmap_title=['MER11A AAF sorted by ZNF525 binding','ChIP-exo ZNF525'], 
