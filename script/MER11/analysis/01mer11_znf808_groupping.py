...
subfam_anno=metadata_age['subgroup'].map(numerical_subgroup)
#%%
...
subgfam_anno_sorted=subfam_anno.reindex(sorted_indices)
#%%
from ma_mapper import plots
import importlib
importlib.reload(plots)
...
plots.plot_experimental(heatmap=True,
    ...
    annotation_data=[subgroup_anno_sorted,subgfam_anno_sorted],
