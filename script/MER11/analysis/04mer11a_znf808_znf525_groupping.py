...
znf808_subgroup_anno_sorted=znf808_subgroup_anno.reindex(sorted_indices)
# %%
#find peaks
import scipy
...
znf525_subgroup_anno_sorted=znf525_subgroup_anno.reindex(sorted_indices)
#%%
metadata_sorted=metadata_age.sort_values(['znf808_group','znf525_group'])
final_sort_indices=metadata_sorted.index
znf808_subgroups = np.unique(metadata_age['znf808_group'].astype(str))
znf808_numerical_subgroup = {subgroup: num for num, subgroup in enumerate(znf808_subgroups)}
znf808_subgroup_anno=metadata_sorted['znf808_group'].map(znf808_numerical_subgroup)
znf525_subgroups = np.unique(metadata_age['znf525_group'].astype(str))
znf525_numerical_subgroup = {subgroup: num for num, subgroup in enumerate(znf525_subgroups)}
znf525_subgroup_anno=metadata_sorted['znf525_group'].map(znf525_numerical_subgroup)
#%%
...
znf808_sorted=znf808[final_sort_indices]
znf525_sorted=znf525[final_sort_indices]
...
plots.plot_experimental(heatmap=True,
    ...
    annotation_data=[znf808_subgroup_anno,znf525_subgroup_anno],
    anno_cbar_label=[['w/ znf808 binding','w/o znf808 binding'],['w/ znf525 binding','w/o znf525 binding']],
    anno_cbar_title=['ZNF808','ZNF525'], 
    colorbar=True,
    colorbar_steps = [0.1,0.0001], 
    agg_major_tick=100
    )
# %%
binding_indices=metadata_sorted[(metadata_sorted['znf808_group']=='A')&(metadata_sorted['znf525_group']=='A')].index
nonbinding_indices=metadata_sorted[(metadata_sorted['znf808_group']=='B')&(metadata_sorted['znf525_group']=='B')].index
phylop_bind = phylop_447[binding_indices]
phylop_nonbind = phylop_447[nonbinding_indices]
...
#%%
# %%
binding_indices=metadata_sorted[(metadata_sorted['znf808_group']=='A')&(metadata_sorted['znf525_group']=='B')].index
nonbinding_indices=metadata_sorted[(metadata_sorted['znf808_group']=='B')&(metadata_sorted['znf525_group']=='B')].index
phylop_bind = phylop_447[binding_indices]
phylop_nonbind = phylop_447[nonbinding_indices]
alignemnt_bind=alignment_filtered[binding_indices]
...
# %%
# %%
binding_indices=metadata_sorted[(metadata_sorted['znf808_group']=='B')&(metadata_sorted['znf525_group']=='A')].index
nonbinding_indices=metadata_sorted[(metadata_sorted['znf808_group']=='B')&(metadata_sorted['znf525_group']=='B')].index
phylop_bind = phylop_447[binding_indices]
phylop_nonbind = phylop_447[nonbinding_indices]
alignemnt_bind=alignment_filtered[binding_indices]
