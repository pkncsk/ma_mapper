...
#%%
metadata_age_sorted=metadata_age.sort_values(['subfam','motif_group','te_age'])
...
plots.plot_experimental(
    ...
    heatmap_title=['ZNF808 and ZNF525 ChIP-exo signal peaks on THE1C,\ngrouped by both signals'],
    heatmap_title_fs = 10, 
...
plots.plot_experimental(
    ...
    opacity = 0.5,
    annotation=True, 
    anno_col = ['Blues',['orange','green','blue','white'],['red', 'yellow', 'blue']], 
    ...
    colorbar=True,
    colorbar_steps=[0.1],
    heatmap_title=['phyloP of THE1C, grouped by ZNF808 and ZNF525 signals'],
    heatmap_title_fs = 10, 
    heatmap_xlabel = 'position (bp)',
    heatmap_xlabel_fs=10,
...
plots.plot_experimental(
    ...
    agg_colset=['blue','red'],
    agg_ylim=[[0,5],[-5,0]],
    agg_yhighlight=[[450,800],[600,625],[650,1050],[780,920]],
    agg_yhighlight_col= ['green','green','blue','blue'],
    agg_yhighlight_alpha=[0.05,0.05,0.05,0.05],
    ...
    agg_ylabel_xpos=0,
    agg_ylabel_fs=10,
    agg_plot_title=[f'phyloP of {subfamily_of_interest}, with both ZNF808 and ZNF525 signals',None],
...
plots.plot_experimental(
    ...
    agg_ylabel_xpos=0,
    agg_ylabel_fs=10,
    agg_plot_title=[f'phyloP of {subfamily_of_interest}, with only ZNF808 signals',None],
    agg_plot_title_fs= 12, 
    agg_xlabel = 'position (bp)',
    agg_xlabel_fs=10,
    agg_plottext=[None, f'TE w/ signals: {len(binding_indices)}\nTE w/o signals: {len(nonbinding_indices)}'],
...
plots.plot_experimental(
    ...
    agg_ylabel_xpos=0,
    agg_ylabel_fs=10,
    agg_plot_title=[f'phyloP of {subfamily_of_interest}, with only ZNF525 signals',None],
    agg_plot_title_fs= 12, 
    agg_xlabel = 'position (bp)',
    agg_xlabel_fs=10,
    agg_plottext=[None, f'TE w/ signals: {len(binding_indices)}\nTE w/o signals: {len(nonbinding_indices)}'],
