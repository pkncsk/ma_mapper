...
znf525_sub = znf525[binding_indices]
alignemnt_sub = alignment_filtered[binding_indices]
cov_znf525_mer11a=mapper.normalise(alignment=alignemnt_sub, mapped_data=znf525_sub, method='perc_coverage')
#%%
subfamily_of_interest = 'MER11B'
binding_indices=metadata_age[metadata_age['subfam']==subfamily_of_interest].index
znf525_sub = znf525[binding_indices]
alignemnt_sub = alignment_filtered[binding_indices]
cov_znf525_mer11b=mapper.normalise(alignment=alignemnt_sub, mapped_data=znf525_sub, method='perc_coverage')
subfamily_of_interest = 'MER11C'
binding_indices=metadata_age[metadata_age['subfam']==subfamily_of_interest].index
znf525_sub = znf525[binding_indices]
alignemnt_sub = alignment_filtered[binding_indices]
cov_znf525_mer11c=mapper.normalise(alignment=alignemnt_sub, mapped_data=znf525_sub, method='perc_coverage')
#%%
...
plots.plot_experimental(
    ...
    heatmap_color=['Blues'],
    heatmap_mode='overlay',
    heatmap_title=['ZNF525 ChIP-exo signal peaks on MER11 MSA'],
    heatmap_title_fs = 10, 
    anno_ylabel = 'sequences',
    anno_ylabel_fs=10,
    vlim = [[0,7]], 
    ...
    aggregated=True, 
    aggregated_data=[cov_znf525,[cov_znf525_mer11a,cov_znf525_mer11b,cov_znf525_mer11c]], 
...
#%%
np.nanmean(cov_znf525_mer11c[800:900])
#%%
...
plots.plot_experimental(
    ...
    agg_colset=[['red','blue'],['blue']],
    ag_opacity=0.5,
    agg_ylim=[[0,0.17],[0,0.17]],
    agg_titles=['forward/\nreverse reads','minimum reads'], 
    agg_titles_fs=10,
    agg_titles_pos=[1.2,0.5],
    agg_plot_title=['ZNF525 ChIP-exo signals on MER11 MSA',None],
    agg_ylabel_ypos=[0.05,None],
    ...
    agg_xlabel = 'position (bp)',
    agg_xlabel_fs=10,
    agg_yhighlight=[[650,1050],[780,920]],
...
#%%
metadata_age_sorted=metadata_age.sort_values(['subfam','znf525_group','te_age'])
sorted_indices= metadata_age_sorted.index
znf808_sorted=znf808[sorted_indices]
znf525_sorted=znf525[sorted_indices]
alignment_sorted = alignment_filtered[sorted_indices]
...
plots.plot_experimental(
    ...
    vlim = [[0,7]], 
    opacity = 0.5, 
    heatmap_title=['ZNF525 ChIP-exo signal peaks on THE1C, grouped by ZNF525 signals'],
    heatmap_title_fs = 10, 
       heatmap_xhighlight=[[940,940],[1475,1475]],
    heatmap_xhighlight_col= ['black','black','black'],
    heatmap_xhighlight_alpha=[0.5,0.5,0.5],
...
plots.plot_experimental(
    ...
    colorbar=True,
    colorbar_steps=[0.1],
    heatmap_title=['phyloP of THE1C, grouped by ZNF525 signals'],
    heatmap_title_fs = 10, 
    heatmap_xlabel = 'position (bp)',
    heatmap_xlabel_fs=10,
    anno_ylabel = 'sequences',
...
binding_indices=metadata_age_filtered[(metadata_age_filtered['znf525_group']=='A')].index
nonbinding_indices=metadata_age_filtered[(metadata_age_filtered['znf525_group']=='B')].index
...
plots.plot_experimental(
    ...
    agg_ylabel_xpos=0,
    agg_ylabel_fs=10,
    agg_plot_title=[f'phyloP of {subfamily_of_interest}, grouped by ZNF525 signals',None],
    agg_plot_title_fs= 12, 
    agg_xlabel = 'position (bp)',
    agg_xlabel_fs=10,
