...
plots.plot_experimental(
    data = [phylop_sorted,znf808_sorted,znf525_sorted], alignment=alignment_filtered, 
    heatmap_color=[custom_cmap.vlag_r_mpl,'Greens','Oranges'],
    heatmap_title=['MER11A PhyloP sorted by ZNF808 binding','ChIP-exo ZNF808','ChIP-exo ZNF525'],  
    ...
    agg_ylim = [[-2,2], [0,100], [-100,0]], 
    agg_ylabel=['phyloP','-log10P','log10P'], 
    agg_major_tick=100,
    agg_titles=['mean phyloP','ZNF808 p>a', 'ZNF808 p<a'],
    colorbar=True, 
...
plots.plot_experimental(
    ...
    heatmap_title=['MER11A PhyloP sorted by ZNF808 binding','ChIP-exo ZNF808'], 
