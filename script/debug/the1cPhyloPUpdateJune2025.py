...
gnomad_matrix=mapper.map_and_overlay(alignment_filepath, gnomad_filepath,data_format='vcf', vcf_format='gnomad', col_threshold = 0.10, col_content_threshold = 0.10, row_threshold = 0.10)
...
ax.set_title('Mean Zoonomia phyloP vs. mean gnomAD alternate allele frequency\nper base on THE1C MSA', fontsize=14)
