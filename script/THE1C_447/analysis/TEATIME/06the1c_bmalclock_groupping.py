...
plots.plot_experimental(
    ...
    agg_ylim=[[0,70],[0,70]],
    agg_titles=['AP-1 motif','clock-p65 motif'], 
...
plots.plot_experimental(
    ...
    show_alignment=True, 
    heatmap_color=['Reds','Oranges','Reds'],
    heatmap_mode='overlay', 
    vlim = [[0,7]], 
    opacity = 0.5, 
...
plots.plot_experimental(
    ...
    anno_cbar_label=[age_subgroups,['both','bmal only','no motif/others']],
    anno_cbar_title=['TEA-TIME','motif group'], 
    colorbar=True,
    colorbar_steps=[0.1]
    )
#%%
binding_indices_test=metadata_age[(metadata_age['bmal']=='A')|(metadata_age['clock']=='A')].index
nonbinding_indices_test=metadata_age[(metadata_age['bmal']=='B')&(metadata_age['clock']=='B')].index
