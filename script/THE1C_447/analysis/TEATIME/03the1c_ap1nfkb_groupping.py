...
plots.plot_experimental(
    ...
    aggregated=True, 
    aggregated_data=[cov_nfkb,cov_ap1], 
    ...
    colorbar=False,
    hm_plot_title = 'AP-1 and NFkB-p65 motif on THE1C MSA',
...
plots.plot_experimental(
    ...
    anno_cbar_label=[age_subgroups,['both','ap1 only','nfkb only','no motif/others']],
    anno_cbar_title=['TEA-TIME','motif group'], 
    colorbar=True,
    colorbar_steps=[0.1]
    )
#%%
binding_indices_test=metadata_age[(metadata_age['ap1']=='A')|(metadata_age['nfkb']=='A')].index
nonbinding_indices_test=metadata_age[(metadata_age['ap1']=='B')&(metadata_age['nfkb']=='B')].index
