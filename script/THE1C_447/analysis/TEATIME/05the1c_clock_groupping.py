...
plots.plot_experimental(
    ...
    opacity = 0.5, 
    annotation=True, 
    anno_col = ['Blues',['purple','orange','blue','white']], 
...
plots.plot_experimental(
    ...
    #logos=True, 
    aggregated=True, 
    aggregated_data=[mean_phylop_bind,mean_phylop_nonbind], 
    agg_colset=['grey','grey'],
    agg_ylim=[[-2,2],[-2,2],[-5,0]],
    ...
    agg_titles=['mean_phyloP_bind','mean_phyloP_nonbind',], 
...
#pos_set = np.append(pos_set)
pos_set = np.arange(224, 232)
#pos_set = np.append(pos_set,[13,51,212,216,363])
#pos_set = np.arange(291, 299)

#pos_set = [10,  18,  51, 77,  97,  98, 101, 122, 183, 210, 211,212, 216, 217, 236, 244, 245, 246, 269, 270, 322, 332, 360, 363]
#pos_set=[ 51,  210, 212, 216, 217, 269, 295, 363,368]
...
motif = 'AP-1'
pos_set = np.arange(61, 69)
#pos_set = np.append(pos_set,[12,46])
#pos_set = np.arange(224, 232)
#pos_set = np.append(pos_set,[13,51,212,216,363])
#pos_set = np.arange(291, 299)
