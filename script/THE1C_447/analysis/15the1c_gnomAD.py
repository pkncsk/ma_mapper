...
ax.text(0.99, 0.92, f'regrssion line: y={res.slope:.2e}x+{res.intercept:.2e}', 
        transform=ax.transAxes, 
        fontsize=12,
        color = 'red', 
        verticalalignment='bottom', 
...
ax.set_ylim(0,0.003)
ax.set_xlabel('mean phyloP per locus', fontsize=12)
ax.set_ylabel('mean alternate allele freqeuncy per locus', fontsize=12)
ax.set_title('mean phyloP vs mean alt allele frequency per locus on THE1C MSA', fontsize=12)
