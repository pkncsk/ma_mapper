...
plots.plot_experimental(
    ...
    heatmap_title=['ZNF267 ChIP-exo signal peaks on THE1C MSA'],
    heatmap_title_fs = 10, 
...
plots.plot_experimental(
    ...
    agg_colset=[['red','blue'],['purple']],
    ag_opacity=0.8,
    
    agg_ylim=[[0,0.11],[0,0.11]],
    agg_titles=['forward/\nreverse reads','minimum reads'], 
    agg_titles_fs=10,
    agg_titles_pos=[1.2,0.5],
    agg_plot_title=['ZNF267 ChIP-exo signals on THE1C MSA',None],
...
#%%
test_set[(test_set['motif_group']=='A')].index
...
plots.plot_experimental(
    ...
    opacity = 0.8,
    hm_transparency_mode = 'gradient', 
    heatmap_title=['ZNF267 ChIP-exo signal peaks on THE1C, grouped by ZNF267 signals'],
    heatmap_title_fs = 10, 
...
plots.plot_experimental(
    ...
    colorbar=True,
    colorbar_steps=[0.1],
    heatmap_title=['phyloP of THE1C, grouped by ZNF267 signals'],
    heatmap_title_fs = 10, 
    heatmap_xlabel = 'position (bp)',
    heatmap_xlabel_fs=10,
    anno_ylabel = 'sequences',
...
plots.plot_experimental(
    ...
    agg_ylabel_xpos=0,
    agg_ylabel_fs=10,
    agg_plot_title=['phyloP of THE1C, grouped by ZNF267 signals',None],
    agg_plot_title_fs= 12, 
    agg_xlabel = 'position (bp)',
    agg_xlabel_fs=10,
...
maybe_motif=alignemnt_bind[:,43:58]
