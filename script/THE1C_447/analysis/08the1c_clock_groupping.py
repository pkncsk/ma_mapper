...
import numpy as np
#%%
te_alignment_folder = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/data/output/ma_mapper/hg38_main/alignment'
...
#%%
subfamily = 'THE1C'
alignment_file = f'{te_alignment_folder}/{subfamily}.fasta.aligned'
...
metadata_age = mapper.match_age_to_id_coordinate(metadata_filtered, age_table=age_default_id)
#%%
coord_file=mapper.extract_coordinate_from_alignment(alignment_file)
#%%
bigwig_file = '/home/pc575/rds/rds-mi339-kzfps/users/pakkanan/phd_project_development/data/zoonomia447/hg38.phyloP447way.bw'
phyloP_matrix=mapper.map_and_overlay(alignment_file, bigwig_file,data_format='bigwig')
#%%
