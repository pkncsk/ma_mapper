...
subfamily_list = te_subfam_list[::-1]
...
#subfamily_list = subfam50k[::-1]
#subfamily_list = subfam50k
#subfamily_list = subfam100k
#subfamily_list = subfam_large
#subfamily_list = ['L2a']
main_folder = '/home/pc575/rds/rds-kzfps-XrHDlpCeVDg/users/pakkanan/phd_project_development/data/_mapper_output/hg38_main/' 
internal_id_folder = f'{main_folder}/internal_id'
...
te_age_folder = f'{main_folder}/age_lenient'
#te_age_folder = f'{main_folder}/age_stringent'
te_age_human_insertion_folder = f'{te_age_folder}/human_insertion'
te_age_segmental_folder = f'{te_age_folder}/segmental'
te_age_unclassified = f'{te_age_folder}/unclassified'
...
combined_age_div_folder = f'{main_folder}/combined_age_div_lenient'
#hyloP_folder = main_folder + '/phyloP'
