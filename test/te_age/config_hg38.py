...
age_ref_table_template = {'age': age_canon, 'representative': ['human', 'chimpanzee','gorilla','orangutan','gibbon','old-world monkey','new-world monkey','primates','close primate relatives','early primate ancestor','rodents','modern eutheria','placental'],'representative_age': ['human (0)', 'chimpanzee (6.7)','gorilla (9.06)','orangutan (15.76)','gibbon (20.19)','old-world monkey (29.44)','new-world monkey (43.2)','primates (73.8)','close primate relatives (76)','early primate ancestor (82)','rodents (90)','modern eutheria(96)','placental mammals (105+)'], 'note':['human', 'ape','ape','ape','gibbon','old-world monkey','new-world monkey','primates','colugos (flying Lemurs)','primitive prosimian/primate','rodents', 'Boreoeutheria', 'Atlantogenata']}
#%%
...
subfamily_list = subfam1k
#subfamily_list = subfam5k
#subfamily_list = subfam10k
#subfamily_list = subfam50k
#subfamily_list = subfam100k
#subfamily_list = subfam_large
...
coord_internal_id_folder = f'{main_folder}/coord_internal_id'
e_value_folder = f'{main_folder}/e_value'
te_age_folder = f'{main_folder}/age'
te_age_bed_folder = f'{main_folder}/age_evi_filtered_bed'
te_age_human_insertion_folder = f'{main_folder}/age/human_insertion'
te_age_segmental_folder = f'{main_folder}/age/segmental'
te_age_unclassified = f'{main_folder}/age/unclassified'
...
kimura_distance_folder = main_folder + '/div'
combined_age_div_folder = main_folder + '/combined_age_div'
phyloP_folder = main_folder + '/phyloP'
