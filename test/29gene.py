    ...
    if pcs_length >=1000:
        ...
        for i in range(len(cds_start_list)):
            ...
            if accumulate_length+frag_length < 500:
                ...
                front.append([chrom, cds_start_list[i], cds_start_list[0]+leftover,strand,metadata_id,])
...
testgene_coord = df = pd.DataFrame(test_length, columns=['genoName','genoStart','genoEnd','strand','id'])
