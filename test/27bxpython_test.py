...
#%%
import pickle
temp_file = open('/home/pc575/rds/rds-mi339-kzfps/users/pakkanan/241genomes/241-mammalian-2020v2b.maf.chrY.index.p', 'rb')
indexes_load=pickle.load(temp_file)
temp_file.close()
#%%
#import pickle
#temp_file = open('/home/pc575/rds/rds-mi339-kzfps/users/pakkanan/241genomes/241-mammalian-2020v2b.maf.chrY.index.p', 'wb')
#pickle.dump(indexes, temp_file)
#temp_file.close()

#%%
#maf_file = '/home/pc575/rds/rds-mi339-kzfps/users/pakkanan/241genomes/241-mammalian-2020v2b.maf.chrY.lzo'
#table_file = '/home/pc575/rds/rds-mi339-kzfps/users/pakkanan/241genomes/241-mammalian-2020v2b.maf.chrY.lzot'
#maf_in=SeekableLzopFile(maf_file, table_file)
#%%
maf_file = '/home/pc575/rds/rds-mi339-kzfps/users/pakkanan/241genomes/241-mammalian-2020v2b.maf.chrY'
maf_in = open(maf_file, "rb")
maf_in = TextIOWrapper(maf_in, encoding="ascii")
#%%
maf_reader = bx.align.maf.Reader(maf_in, parse_e_rows=True)
...
while True:
    if i < 10:
        ...
        for c in block.components:
            if species is not None and c.src.split(".")[0] not in species:
                continue
            print(c.src, c.forward_strand_start, c.forward_strand_end, pos, c.src_size)
    else:
        break  
#%%
while True:
    ...
    for c in block.components:
        ...
        indexes.add(c.src, c.forward_strand_start, c.forward_strand_end, pos, max=c.src_size)
#%%
index_file = '/home/pc575/rds/rds-mi339-kzfps/users/pakkanan/241genomes/241-mammalian-2020v2b.maf.chrY.test_index'
out = open(index_file, "wb")
indexes_load.write(out)
out.close()
#%%
